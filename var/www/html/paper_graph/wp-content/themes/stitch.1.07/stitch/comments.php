 ...
 * handled by a callback to stitch_comment() which is
	...
	<?php if ( have_comments() ) : ?>
		...
		<ol class="commentlist">
			<?php
				 ...
				 * to use stitch_comment() to format the comments.
				 * If you want to overload this in a child theme then you can
				 * define stitch_comment() and that will be used instead.
				 * See stitch_comment() in inc/template-tags.php for more.
				 */
